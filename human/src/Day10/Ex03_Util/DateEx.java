...
public class DateEx {
	...
	public static void main(String[] args) throws ParseException {
		// Date 객체는 시스템에서 현재 날짤르 가져온 정보를 가지고 있다
		Date now = new Date();
		...
		System.out.println("100일후:" +after100DayStr);
