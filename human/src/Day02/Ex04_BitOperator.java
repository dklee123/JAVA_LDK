...
public class Ex04_BitOperator {
	...
	public static void main(String[] args) {
		...
		// Integer.toBinaryStrinf() : 십진수 숫자를 이진수 문자열로 변환하는 메소드
		...
		System.out.println(2 << 2);				// 왼쪽으로 비트를 1칸 이동
		System.out.println(2 << 3);				// 왼쪽으로 비트를 1칸 이동
		System.out.println();
		
		System.out.println(">> 연산하면 1/2배씩 감소");
		System.out.println(16 >> 1);				// 오른쪽으로 비트를 1칸 이동
		System.out.println(16 >> 2);				// 오른쪽으로 비트를 1칸 이동
		System.out.println(16 >> 3);				// 오른쪽으로 비트를 1칸 이동
		System.out.println();
